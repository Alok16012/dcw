...
import { absorbCatalogueOptions } from './option-usage.js';
...
export function ensureSeeded() {
  ...
  seedFeePlans();
  // After the rows exist, so every stream, mode and institution type the
  // catalogue already uses is offered in the dropdown that edits it.
  absorbCatalogueOptions();
}
