...
export class ApiError extends Error {
  constructor(status, payload) {
    ...
    /* Routes attach their own detail to a failure — the publish check returns a
       checklist with its 409, for instance. Keeping the whole envelope means a
       caller can read that without this class growing a field per route. */
