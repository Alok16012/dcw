 ...
 *  'photo' is the odd one out — it is not evidence of anything, it is the campus
 *  picture the public card leads with. It goes through the same store because
 *  the store is what holds a file, and keeping a second upload path for images
 *  would mean two things to swap when this becomes Supabase Storage. */
export const DOC_PURPOSES = ['proof', 'approval', 'prospectus', 'brochure', 'photo', 'other'];
