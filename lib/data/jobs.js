 ...
 */
/* Proof of Work seeds, the same shape lib/proof.js builds. An employer proves
   itself with an offer letter or a photograph from a hiring drive, where an
   institution proves itself with a result sheet — different evidence, one card.
   `url` is null on purpose: see the note on the matching helper in
   lib/data/institutions.js. */
const pow = (owner, n, kind, title, year, summary) => ({
  id: `pow-${owner}-${n}`, kind, title, year, summary,
  courseName: null, documentId: null, documentName: null, mimeType: null, url: null,
  addedBy: 'seed', addedAt: `${year}-07-01T00:00:00.000Z`
});
...
export const companies = [
  { id: 'bajaj-finserv', name: 'Bajaj Finserv', mark: 'BF', isVerified: true, rating: 4.6, reviews: 203,
    ...
    proofOfWork: [
      pow('bajaj-finserv', 1, 'Placement', 'Offer letters, Patna hiring drive 2025', 2025,
        'Eleven offers issued to candidates who applied through Berojgar Bharat, names removed.'),
      pow('bajaj-finserv', 2, 'Certificate', 'GST and PAN on file', 2025,
        'Company registration documents checked before the employer was allowed to post.')
    ] },
  { id: 'teleperformance', name: 'Teleperformance', mark: 'TP', isVerified: true, rating: 4.5, reviews: 188,
    ...
    proofOfWork: [
      pow('teleperformance', 1, 'Event', 'Walk-in drive, Kankarbagh, March 2025', 2025,
        'Photographs and the signed attendance register from the joint hiring day.')
    ] },
  { id: 'vibrant-infotech', name: 'Vibrant Infotech', mark: 'VI', isVerified: true, rating: 4.3, reviews: 91,
    ...
    proofOfWork: [
      pow('vibrant-infotech', 1, 'Placement', 'Appointment letter, data entry executive', 2025,
        'Issued to a candidate placed through us in April 2025, salary matching the posting.')
    ] },
